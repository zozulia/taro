<?php
require_once(__DIR__ . '/../sender/dbconfig.php');
require_once(__DIR__ . '/../edit/lib_db.php');
require_once(__DIR__ . '/../sender/lib_mail.php');
...
if (is_array($db->_rows)){
	$template = file_get_contents(__DIR__ . '/letter2.html');
...
if (is_array($db->_rows)){
	$template = file_get_contents(__DIR__ . '/letter3.html');
	$template = strtr($template,array('{--date--}'=>$date));
	$rows = $db->_rows;	
